...
def main():
    st.title("P112 Group_5 Resume Classifier")
    ...
    if choice=="Home":
        ...
        st.header("Welcome to Resune Classifier by Group 5")
        st.subheader("Geerath Bhat")
        st.subheader("Joshua Daniel")
        st.subheader("Rushikesh Gore")
        st.subheader("Suraj Takkekar")
        st.subheader("Kedar Chougule")
        st.subheader("Rakhi")
